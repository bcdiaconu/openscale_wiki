Protocol description for Beurer/Sanitas scales ([code](https://github.com/oliexdev/openScale/blob/master/android_app/app/src/main/java/com/health/openscale/core/bluetooth/BluetoothBeurerSanitas.java)).
